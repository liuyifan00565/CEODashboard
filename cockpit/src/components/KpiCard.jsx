/* 更新时间: 2026-07-13 22:00:00 CST  更新内容: 年度回款半环图“未完成”标注位改为 y:238（原 y:156 与线下华南的 y:158
   几乎重叠，年度未达标有缺口时两个标签会挤在一起互相遮挡，看起来像“未完成”标注时有时无）；沿用现有 40px
   步进延伸到序列末尾，与线下华东(198)保持间距。 */

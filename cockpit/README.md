...
年度默认折叠以降低首屏高度；展开后，月度与年度回款结构半环仍使用相同尺寸：桌面端图区高度为 218px，图表宽度使用 380px 到 480px 的响应范围；低高度桌面档统一为 208px 和 360px 到 440px。下方继续保留原有业务拆解模块：月度经营趋势、开户数、总投入费比、版本情况和交付面板，用于解释经营结果背后的趋势、成本、产品和交付状态。

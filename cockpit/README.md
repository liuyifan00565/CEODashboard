...
更新内容: 年度节奏说明改为四项核心指标和年度进度胶囊条，移除折线趋势图描述。
...
年度节奏以 `src/data/mock.js` 中的 `KPI.yearRecovered` 和 `KPI.yearTarget` 为权威值；卡片展示 `年度累计回款 3,120万`、`年度目标 5,800万`、`年度完成率 53.8%`、`时间进度 50.0%` 四项核心指标，并用年度进度胶囊条表达 `已完成 53.8%` 与 `剩余 46.2%`。经营判断固定展示：“当前领先时间进度 3.8%，但线下华东连续低于目标节奏。”并补充 `下半年月均需完成 447 万`。
